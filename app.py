...
SOLUTION_PAGE_CONTENT = {
    'stok_takip_programi': {
        ...
        'headline': 'Barkodlu stok takibini sade, hızlı ve hatasız yönet.',
        'description': 'Esstok stok takip programı; küçük işletmelerin ürün, barkod, depo, stok giriş-çıkış, kritik stok ve POS satış sonrası otomatik stok düşümünü tek panelden yönetmesine yardımcı olur.',
        'eyebrow': 'Stok yönetimi',
        'icon': 'inventory_2',
        'hero_points': ['Barkodlu ürün arama ve satış', 'Kritik stok uyarıları', 'Toplu stok ve fiyat güncelleme', 'POS satışla otomatik stok düşümü'],
        'sections': [
            ...
            ('Barkodlu stok nasıl çalışır?', 'USB barkod okuyucu ile ürün okutulduğunda ürün hızlıca bulunur. POS ekranındaki satış tamamlandığında ilgili ürün stoktan otomatik düşer; stok hareketi geçmişe kaydedilir.'),
            ('Neden küçük işletmeler için uygun?', 'Karmaşık ERP ekranları yerine sade kartlar, anlaşılır tablolar ve hızlı arama mantığı kullanılır. Kullanıcı ürününü bulur, miktarı görür ve işlemine devam eder.'),
        ],
        'features': ['Barkod ve ürün adıyla arama', 'Kritik stok takibi', 'Toplu stok yükleme', 'Toplu fiyat güncelleme', 'Stok giriş/çıkış geçmişi', 'Satış sonrası otomatik düşüm', 'Depo bazlı takip', 'Mobil ve masaüstü erişim'],
        'workflow_title': 'Stok akışı nasıl ilerler?',
        'workflow_steps': [
            ('1', 'Ürünü tanımla', 'Ürün adı, barkod, alış/satış fiyatı ve kritik stok seviyesini gir.'),
            ('2', 'Stok girişini yap', 'Tedarikçiden gelen ürünleri tek tek veya Excel şablonuyla toplu ekle.'),
            ('3', 'POS ile satış yap', 'Kasada barkod okutulduğunda ürün sepete eklenir ve satış sonrası stoktan düşer.'),
            ('4', 'Kritik ürünleri izle', 'Azalan stokları ve stok hareket geçmişini panelden kontrol et.'),
        ],
        'scenarios_title': 'Hangi işletmeler için uygun?',
        'scenarios': [
            ('Hırdavat ve yapı market', 'Çok sayıda küçük parçayı barkod, kategori ve kritik stok mantığıyla takip et.'),
            ('Market ve küçük perakende', 'Kasada hızlı satış yaparken stokların otomatik güncel kalmasını sağla.'),
            ('Servis ve yedek parça', 'Kullanılan parçaların giriş-çıkışını ve kalan miktarını düzenli izle.'),
            ('Toptan satış', 'Toplu ürün girişleri, fiyat güncellemeleri ve cari bağlantılı satışları takip et.'),
        ],
        'comparison_title': 'Ücretsiz tablo yerine neden stok programı?',
        'comparison': [
            ('Excel / defter', 'Stok manuel güncellenir, satış sonrası unutulabilir, kimin ne yaptığı zor takip edilir.'),
            ('Esstok', 'Satış, stok hareketi, kritik seviye ve cari bağlantısı aynı akışta otomatik takip edilir.'),
        ],
        'faq': [
            ...
            ('Kritik stok uyarısı var mı?', 'Evet. Ürün için belirlenen kritik seviyenin altına düşen stoklar panelde daha görünür hale getirilebilir.'),
            ('Barkod okuyucu şart mı?', 'Hayır. Barkod okuyucu kasada hız kazandırır; ürün adıyla arama ve manuel seçim de kullanılabilir.'),
        ],
    },
